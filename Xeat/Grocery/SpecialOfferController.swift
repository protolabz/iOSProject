...
class SpecialOfferController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    @IBAction func btnUpdate(_ sender: Any) {
        let txt = txtAlertItemCount.text
        txtCount = Int(txt!)!
        print("=============================")
        print(txtCount)
        ...
        {
            let strCommission = "\(self.arrOfGroceryItem[selectedPosition]["commission"])"
            ...
            let discountedPrice = itemPrice - Double("\(self.arrOfGroceryItem[selectedPosition]["discount_price"])")!
            let commissionPrice =  "\(discountedPrice)"
            ...
            let actualPrice = "\(aPrice)"
            viewPlusMinus.isHidden = true
            addDeleteToCartAPI(position : selectedPosition, operation : "2", commissionPrice: commissionPrice ,count: strText!, actualPrice : actualPrice, strInstruction:  "")
...
//            let aPrice = Double("\(self.arrOfGroceryItem[selectedPosition]["full_price"])")! - Double("\(self.arrOfGroceryItem[selectedPosition]["discount_price"])")!
    ...
    func groceryAPI()
    {
        ...
        let parameters = ["sub_id": "1", "accesstoken" : Constant.APITOKEN, "user_long" : strLongitude, "user_lat" : strLatitude]
