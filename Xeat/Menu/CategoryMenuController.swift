...
class CategoryMenuController: UIViewController, UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate, UISearchBarDelegate {
...
var strRestId = ""
    ...
    override func viewDidLoad() {
      ...
      //  edSearch.delegate = self
        ...
        txtHeading.text = strCategoryName
            print(searchId)
            menuSearch()
